  ...
  const redeemItems: RedeemItem[] = [
    {
      ...
      category: "Medication",
      imageSrc: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 2,
      ...
      category: "Equipment",
      imageSrc: "https://images.unsplash.com/photo-1584982751601-97dcc096659c?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 3,
      name: "ORS Solution",
      ...
      category: "Hydration",
      imageSrc: "https://images.unsplash.com/photo-1609644124044-84c3b5ee4ac3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 4,
      name: "Bandages (Pack)",
    ...
    },
    {
      ...
      icon: <Droplet className="h-10 w-10 text-blood" />,
      category: "First Aid",
      imageSrc: "https://images.unsplash.com/photo-1603807008857-ad66b70431e2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 6,
      ...
      category: "Equipment",
      imageSrc: "https://images.unsplash.com/photo-1579154392429-0e6b4e850ad9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 7,
      name: "First Aid Kit",
      ...
      category: "First Aid",
      imageSrc: "https://images.unsplash.com/photo-1603398880678-e1e8ee32a158?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    },
    {
      id: 8,
      ...
      imageSrc: "https://images.unsplash.com/photo-1577196582428-f85744ee7d9a?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
    }
  ];
              ...
              <Card key={item.id} className="overflow-hidden hover:shadow-md transition-all duration-300 border border-blood/10 flex flex-col">
                <div className="h-48 overflow-hidden">
                  {item.imageSrc ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-blood/5">
                      {item.icon}
                    </div>
                  )}
                </div>
